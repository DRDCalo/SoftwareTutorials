...
SIM.compactFile = [os.path.join(_HERE, "compact", "simplecalo1.xml")]
...
# where the notebooks look for it (see drdcalo_tutorials.simplecalo1_input).
# --outputFile on the ddsim command line still overrides this.
SIM.outputFile = os.path.join(_TUTORIAL_DIR, "simplecalo1.root")
